      ...
      >
        ...
        <el-col :span="12">
            <el-form-item label="会员证书编号" size="mini" prop="certificateNo">
              <el-input v-model="mainForm.certificateNo" size="mini" maxlength="200" :readonly="true"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item label="身份标记" size="mini" prop="identityMark">
              <el-input v-model="mainForm.identityMark" size="mini"  :readonly="true"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="6">
            <el-form-item label="身份标记时间" size="mini" prop="identityMarkDate">
              <el-input v-model="mainForm.identityMarkDate" size="mini"  :readonly="true" ></el-input>
            </el-form-item>
          </el-col>
  ...
  methods: {
    ...
    auditDialogCallBack(command, data) {
      ...
      if (command == "ok") {
        ...
        auditMember(id, auditType, auditReason, identityMark).then(response => {
          this.$message({
            type: "success",
            message: "操作成功!"
          });

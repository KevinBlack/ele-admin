<template>
  <el-card class="detailsContainer">
    ...
    >
      ...
      <el-table-column prop="registeredFunds" label="注册资金" width="100" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleView() {
      ...
      var id = rows[0].id
      this.$router.push({ path: "/hxxdMemberManage/member-detail", query: {id: id} });
    },
    //导出
    handleExport() {
    ...
    auditDialogCallBack(command, data) {
      ...
      if (command == "ok") {
        ...
        auditMember(ids, auditType, auditReason).then(response => {
          this.$message({
            type: "success",
            message: "操作成功!"
          });

  ...
  <el-card class="detailsContainer">
    ...
    >
      ...
      <el-table-column prop="time" label="日期" width="250" align="center"></el-table-column>
      <el-table-column prop="header" label="消息标题" width="325" align="center"></el-table-column>
      <el-table-column prop="despatcher" label="发送人" width="250" align="center"></el-table-column>
